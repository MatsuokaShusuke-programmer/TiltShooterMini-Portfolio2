...
※Playには「Nintendo Switch Joy-Con」が必要です。

## 開発環境/制作体制
* **制作人数**:1人
* **制作期間**
  * **初期バージョン**:2025/7/3~10
  * **ブラッシュアップ**:2025/7/24~10/3
  * **ブラッシュアップ**:2026/3/12~13
* **制作時間**
  * **初期バージョン**:約8時間
  * **ブラッシュアップ**:約71時間
  * **ブラッシュアップ**:約1時間
...
* **ライブラリ**:JoyconLib
* **使用言語**:C#
* **ジャンル**:3DJoy-Conシューティング
* **動画**:https://youtu.be/uTLdnRBoIBU?si=r9ldB9Kvhm_N9li1

## 操作説明
※Joy-Con(1本)を横持ちで操作します。
* 移動:Joy-Conの傾き,スティックの前後
* ショット:SL/SR
* ボタン選択:スティック
* 決定:X/下
...
* **Space Shuttle**(提供元:Amint3D, from Unity Asset Store):Playerのモデルとして使用。
